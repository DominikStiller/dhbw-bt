...
\begin{figure}
	...
	\caption[Log partitioning]{Log partitioning: each partition is an independent log with internal total order. Load balancing is used as multi-consumer pattern, but multiple consumers could also read the same partition for fan-out.}
