...
\begin{figure}
	...
	\begin{subfigure}[c]{0.33\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{plot_usecase_analytics_emergency_stop}%
