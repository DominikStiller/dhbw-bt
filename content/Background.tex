...
\begin{figure}
	...
	\caption[Example of a dataflow graph]{Example of a dataflow graph: two streams are joined, transformed and emitted as a single stream}
...
\begin{figure}
	\begin{subfigure}[c]{0.37\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{background_window_types_tumbling}%
		\subcaption{Tumbling}
	\end{subfigure}
	\begin{subfigure}[c]{0.30\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{background_window_types_sliding}%
		\subcaption{Sliding}
	\end{subfigure}
	\begin{subfigure}[c]{0.30\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{background_window_types_session}%
		\subcaption{Session}
	\end{subfigure}
...
\begin{figure}
	\begin{subfigure}[c]{0.49\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{plot_background_window_domains_processing}%
		\subcaption{Processing time}
		\label{fig:background-window-domains-processing}
	\end{subfigure}
	\begin{subfigure}[c]{0.49\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{plot_background_window_domains_event}%
